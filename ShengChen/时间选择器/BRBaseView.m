...
- (UIView *)alertView {
    if (!_alertView) {
        ...
        _alertView.backgroundColor = GETColor(221, 221, 221);
        // 设置子视图的大小随着父视图变化
...
- (UIView *)topView {
    if (!_topView) {
        _topView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.alertView.frame.size.width, 44)];
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:14.0f * kScaleFit];
        
        [_leftBtn setTitleColor:[UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.titleLabel.font = [UIFont systemFontOfSize:14.0f * kScaleFit];
        
        [_rightBtn setTitleColor:[UIColor colorWithRed:72/255.0 green:155/255.0 blue:231/255.0 alpha:1] forState:UIControlStateNormal];
