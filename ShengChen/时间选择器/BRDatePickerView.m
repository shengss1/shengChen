...
- (UIDatePicker *)datePicker {
    if (!_datePicker) {
        ...
        _datePicker.backgroundColor = [UIColor colorWithRed:221/255.0 green:221/255.0 blue:221/255.0 alpha:1];
        // 设置子视图的大小随着父视图变化
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        ...
        _pickerView.backgroundColor = [UIColor colorWithRed:221/255.0 green:221/255.0 blue:221/255.0 alpha:1];
        // 设置子视图的大小随着父视图变化
